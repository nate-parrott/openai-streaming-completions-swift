...
extension OpenAIAPI {
    ...
    public struct ChatCompletionRequest: Codable {
        ...
        public init(messages: [Message], model: String = "gpt-3.5-turbo", max_tokens: Int = 1500, temperature: Double = 0.2, presencePenalty: Double = 0.0, frequencyPenalty: Double = 0.0, topP: Double = 1.0, stop: [String]? = nil) {
    ...
    public func completeChatStreaming(_ completionRequest: ChatCompletionRequest) throws -> AsyncStream<Message> {
        ...
        print("completeChatStreaming() - request: \(request)")
